...
-- Primeiro, vamos alterar a estrutura da coluna para suportar strings (sintaxe H2)
...
-- Adicionar constraint para garantir apenas valores válidos do enum (sintaxe H2)
